document.addEventListener('DOMContentLoaded', function() {
    ...
    function showOptions(options) {
        ...
        mensagensDivDaily.appendChild(optionsDiv);
    }
    ...
    $('#myModalDaily').on('shown.bs.modal', function () {
        startConversation();
    });
});